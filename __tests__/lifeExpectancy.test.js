...
describe("LifeExpectancy", () => {
  ...
  test("Should return average Earth life expectancy, user's age in Earth years, and how many years they have lived past average life expectancy.", () => {
    const newLifeExpectancy = new LifeExpectancy("Earth", 75, 73);
    expect(newLifeExpectancy.earthExpectancy()).toEqual("Average life expectancy for your demographic on Earth: 73. Your age in Earth years: 75. Years lived beyond life expectancy: 2.");
  });
