...
describe("LifeExpectancy", () => {
  ...
  test("Should return average Earth life expectancy, user's age in Earth years, and how many Earth years they have left live.", () => {
    ...
    expect(newLifeExpectancy.earthExpectancy()).toEqual("Average life expectancy for your demographic on Earth: 73. Your age in Earth years: 31. Earth years left to live: 41");
  });
