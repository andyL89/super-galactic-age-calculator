export default class LifeExpectancy {
  ...
  earthExpectancy() {
    if (this.age > this.expectancy) {
      return `Average life expectancy for your demographic on ${this.planet}: ${this.expectancy}. Your age in ${this.planet} years: ${this.age}. Years lived beyond life expectancy: ${Math.round(this.age - this.expectancy)}.`;
    } else {
